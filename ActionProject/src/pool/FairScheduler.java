...
public class FairScheduler extends Scheduler {
	...
	/**
	 * Method who does the action : execute action with a fair distribution of
	...
	/**
	 * Method used in doStep function of FairScheduler class who returns the
	 * first action not finished of his action list next the last action
	 * executed
	 * 
	 * @return
	 */
	public Action getAfterActionNotFinished() {
		...
		/*
		 * If the search doesn't succeed, we look before the index begin at the
		 * list action start
		 */
